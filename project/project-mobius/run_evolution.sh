...
export EVOLVER_WORKSPACE="$MOBIUS_WORKSPACE_DIR"
...
export NEXAU_DENY_RUN_SHELL_SUBSTRINGS="${NEXAU_DENY_RUN_SHELL_SUBSTRINGS:-}"
...
ARGS=(python -u "$EVOLVER_ROOT/scripts/run_evolution.py" --workspace "$MOBIUS_WORKSPACE_DIR" --iterations "$ITERATIONS" --evaluate-script "$EVALUATE_SCRIPT_PATH")
